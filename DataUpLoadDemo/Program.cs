...
namespace DataUpLoadDemo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            monitordata monitordatamodel = new monitordata() { companyid = companyid, equipmentcode = "5FF45AB7-1E72-4381-A0A6-264BDE90F54F", datetime = "2019-04-18 12:00:00", surveytypecode = "EXH_Real",datas=new List<data>() { data1, data2, data3, data4 } };
